...
const Book = ({book}) => {
    ...
    return (
        <div>
            ...
            <div className="card w-full my-10 border p-6 bg-base-100 shadow-xl">
  ...
  <div className='flex justify-center gap-5'>
    {
        tags.map((tag,idx)=> <button key={idx} className="btn btn-xs bg-green-50 text-green-500 font-medium">{tag}</button>)
    }
  </div>
